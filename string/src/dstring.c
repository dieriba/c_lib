...
{
    return d_string_find_first_char_not_of_str_from_index(dstring, str, 0);
}
...
{
    return d_string_find_last_of_matching_char_from_index(dstring, c, dstring -> len);
}
...
{
    return d_string_find_last_char_not_of_str_from_index(dstring, str, dstring -> len);
}
...
{
    return d_string_find_first_not_of_predicate_from_index(dstring, fn , 0);
}
...
{
    return d_string_find_last_not_of_predicate_from_index(dstring, fn , dstring -> len);
}
...
{
    return d_string_find_matching_str_from_index(dstring, str, 0);
}
...
{
    usize i = d_string_find_last_of_matching_char_from_end(dstring, c);
    if (i == MAX_SIZE_T_VALUE)
        return dstring;

...
const void *container_get_cdata(const Container *container);
...
bool container_has_opt(const Container *container, ContainerOpts opt);

Result container_set_opt(Container *container, ContainerOpts opt);
void container_unset_opt(Container *container, ContainerOpts opt);
Result container_set_opts(Container *container, DBits8 opts);
